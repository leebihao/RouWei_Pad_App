 ...
 */
public class MultiAirKissConfigTask extends ScinanConfigDeviceTask implements UDPClient.UDPClientCallback2 {
    ...
    public MultiAirKissConfigTask(Context context, ScinanConnectDevice scinanDevice, ConfigDeviceCallback callback) {
        super(context, scinanDevice, callback);
    }

    public MultiAirKissConfigTask(Context context, ScinanConnectDevice scinanDevice, ConfigDeviceCallback2 callback) {
        super(context, scinanDevice, callback);
    }
...
//            }
            ...
            if (stringBuffer.toString().contains(data)) {
                return;
            }

            stringBuffer.append(data);
            HardwareCmd hardwareCmd = getHardwareCmd(data);
...
//            publishProgress(String.valueOf(STEP_DATA));
        } catch (Exception e) {
            logE(e);
            e.printStackTrace();
        }
        ...
        mUDPServer.setCallback(new UDPServer.UDPServerCallback() {
            ...
            public void onUDPEnd(UDPData data) {
                ...
                if (TextUtils.equals(random, String.valueOf(mRandomStr)) && !sbSended) {
                    ...
                    mUDP.setCallback2(MultiAirKissConfigTask.this);
                    mUDP.connect();
                }
            }
        });
