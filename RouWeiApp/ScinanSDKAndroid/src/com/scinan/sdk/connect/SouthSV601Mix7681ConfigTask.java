 ...
 */
public class SouthSV601Mix7681ConfigTask extends ScinanConfigDeviceTask implements UDPClient.UDPClientCallback2 {
    ...
    public SouthSV601Mix7681ConfigTask(Context context, ScinanConnectDevice scinanDevice, ConfigDeviceCallback callback) {
        super(context, scinanDevice, callback);
    }

    public SouthSV601Mix7681ConfigTask(Context context, ScinanConnectDevice scinanDevice, ConfigDeviceCallback2 callback) {
        super(context, scinanDevice, callback);
    }
...
//                    sendSMTBroadcast();
    ...
    void sendSMTBroadcast() {
        ...
        mUDP.setCallback2(SouthSV601Mix7681ConfigTask.this);
        mUDP.connect(5000);
    }
