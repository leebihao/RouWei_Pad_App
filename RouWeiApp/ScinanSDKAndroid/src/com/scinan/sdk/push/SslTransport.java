...
public class SslTransport extends TcpTransport implements SecuredSession {
    ...
    public SslTransport(Context context) {
        super(context);
    }
     ...
     * TcpTransport.
     */
    public static SslTransport createTransport(Context context, URI uri) throws Exception {
        String protocol = protocol(uri.getScheme());
        if( protocol !=null ) {
            SslTransport rc = new SslTransport(context);
