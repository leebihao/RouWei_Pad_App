...
public class AbPullToRefreshView extends LinearLayout {
    ...
    /** header view. */
    protected AbListViewHeader mHeaderView;

    /** footer view. */
    protected AbListViewFooter mFooterView;
    ...
    /** Footer加载更多监听器. */
    protected OnFooterLoadListener mOnFooterLoadListener;
     ...
     * @return the int
     */
    protected int updateHeaderViewTopMargin(int deltaY) {
