...
public class HexUtil {
    ...
    public static String bytesToAscill(byte[] bArray) {
        return hex2Ascii(bytesToHexString(bArray));
    }
    ...
    public static String byteArray2HexString(byte[] paramArrayOfByte, int length)
    {
        int i = length;
    ...
    public static String password2hex(int src) {
        String origin = Integer.toHexString(src).toUpperCase();
        while (origin.length() < 6) {
            origin = "0" + origin;
        }
        Log.e("password2hex" + src, origin);
        return origin;
    }
    ...
    public static int byteArray2int(byte[] paramArrayOfByte, int length) {
        return hex2int(byteArray2HexString(paramArrayOfByte, length));
    }

    public static String getTimeHex() {
        String old = AndroidUtil.getTimeString(System.currentTimeMillis(), "yyMMddHHmm");
        String a = "";
