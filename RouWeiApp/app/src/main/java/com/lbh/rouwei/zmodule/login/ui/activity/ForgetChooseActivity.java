...
import com.lbh.rouwei.zmodule.login.ui.fragment.FragmentForgetByEmail;
import com.lbh.rouwei.zmodule.login.ui.fragment.FragmentForgetByPhone;
...
public class ForgetChooseActivity extends BaseMvpActivity implements RadioGroup.OnCheckedChangeListener {
    ...
    private FragmentForgetByEmail mFragmentByEmail;
    private FragmentForgetByPhone mFragmentByPhone;
        ...
        switch (checkedId) {
            case R.id.phoneRB:
                if (mFragmentByPhone == null) {
                    mFragmentByPhone = FragmentForgetByPhone.newInstance("", "");
                }
            ...
            case R.id.emailRB:
                if (mFragmentByEmail == null) {
                    mFragmentByEmail = FragmentForgetByEmail.newInstance("", "");
                }
