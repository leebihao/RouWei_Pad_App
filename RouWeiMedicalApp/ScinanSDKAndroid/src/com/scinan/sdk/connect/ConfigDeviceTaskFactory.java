...
/**
 * Created by lijunjie on 16/3/24.
 */
public class ConfigDeviceTaskFactory {
    ...
    //一键多配
    public static final int Multiple_AIRKISS                         = 10;
    ...
    public static ScinanConfigDeviceTask getTask(Context context, int mode, ScinanConnectDevice scinanDevice, ConfigDeviceCallback callback) {
        ...
        switch (mode) {
            ...
            case SMART_6120:
                ...
                break;
            case Multiple_AIRKISS:
                task = new MultiAirKissConfigTask(context, scinanDevice, callback);
