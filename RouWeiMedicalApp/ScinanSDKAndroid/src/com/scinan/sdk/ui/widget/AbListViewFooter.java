...
public class AbListViewFooter extends LinearLayout {
	...
	public void setState(int state) {
		...
		if (state == STATE_READY) {
			...
			footerProgressBar.setVisibility(View.GONE);
			footerTextView.setText(R.string.loadingmore);
		} else if (state == STATE_LOADING) {
			footerView.setVisibility(View.VISIBLE);
			footerTextView.setVisibility(View.VISIBLE);
			footerProgressBar.setVisibility(View.VISIBLE);
			footerTextView.setText(R.string.zhengzaijiazai);
		}else if(state == STATE_NO){
			footerView.setVisibility(View.GONE);
			footerTextView.setVisibility(View.VISIBLE);
			footerProgressBar.setVisibility(View.GONE);
			footerTextView.setText(R.string.none);
		}else if(state == STATE_EMPTY){
			footerView.setVisibility(View.GONE);
			footerTextView.setVisibility(View.GONE);
			footerProgressBar.setVisibility(View.GONE);
			footerTextView.setText(R.string.nodata);
		}
		mState = state;
	}
